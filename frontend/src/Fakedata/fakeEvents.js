...
const fakeEvents = [
    ...
    { id: 15, title: "Live Jazz Evening", date: addDaysToDate(currentDate, 1), location: "Santa Rosa, CA", description: "A relaxing jazz night with local artists.", category: "Music", lat: 38.4404, lng: -122.7141, distance: 5 },
    ...
    { id: 18, title: "Yoga in the Park", date: addDaysToDate(currentDate, 2), location: "Golden Gate Park, CA", description: "An outdoor yoga session for all skill levels.", category: "Health & Fitness", lat: 37.7694, lng: -122.4862, distance: 5 },
    ...
    { id: 8, title: "California State Fair", date: addDaysToDate(currentDate, 3), location: "Sacramento, CA", description: "A family-friendly fair featuring carnival rides, food, and concerts.", category: "Health & Fitness", lat: 38.5809, lng: -121.4997, distance: 100 },
