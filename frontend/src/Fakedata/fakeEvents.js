const fakeEvents = [
    //Music Events
    { id: 1, title: "Outside Lands Music Festival", date: "2025-03-21", location: "San Francisco, CA", description: "A major music festival featuring top artists.", category: "Music", lat: 37.7694, lng: -122.4862, distance: 5 },
    { id: 2, title: "Monterey Jazz Festival", date: "2025-09-20", location: "Monterey, CA", description: "A world-class jazz festival.", category: "Music", lat: 36.6002, lng: -121.8947, distance: 50 },
    { id: 3, title: "BottleRock Napa Valley", date: "2025-05-24", location: "Napa, CA", description: "A music, wine, and culinary festival.", category: "Music", lat: 38.2975, lng: -122.2869, distance: 25 },
    ...
    { id: 15, title: "Live Jazz Evening", date: "2025-03-20", location: "Santa Rosa, CA", description: "A relaxing jazz night with local artists.", category: "Music", lat: 38.4404, lng: -122.7141, distance: 5 },
  
    //Added Business Event for Tomorrow
    { id: 16, title: "Startup Networking Mixer", date: "2025-03-21", location: "San Jose, CA", description: "Meet fellow entrepreneurs and investors.", category: "Business", lat: 37.3382, lng: -121.8863, distance: 10 },
  
    //Added Food & Drink Event for This Week
    { id: 17, title: "Wine & Cheese Tasting", date: "2025-03-22", location: "Sonoma, CA", description: "Explore local wineries with a curated tasting experience.", category: "Food & Drink", lat: 38.2919, lng: -122.4580, distance: 10 },
  
    //Added Health Event for This Weekend
    { id: 18, title: "Yoga in the Park", date: "2025-03-23", location: "Golden Gate Park, CA", description: "An outdoor yoga session for all skill levels.", category: "Health & Fitness", lat: 37.7694, lng: -122.4862, distance: 5 },
