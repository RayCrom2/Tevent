...
function addDaysToDate(dateStr, daysToAdd) {
  ...
  date.setDate(date.getDate() + daysToAdd); // Adds the days
...
const newDate = addDaysToDate(currentDate, 5); // You can change the number of days to add here
console.log(addDaysToDate(currentDate, 5));
console.log(currentDate);
// (Number(currentDay) + Number(2)) < Number(10) ? console.log(currentDate.slice(0, -2) + 0 + (Number(currentDay) + Number(6))) : console.log(currentDate.slice(0, -2) + (Number(currentDay) + Number(2)));
// console.log(currentDate.slice(0, -2) + " " + (Number(currentDay) + Number(2)));
const fakeEvents = [
    //Music Events
    { id: 1, title: "Outside Lands Music Festival", date: addDaysToDate(currentDate, 5), location: "San Francisco, CA", description: "A major music festival featuring top artists.", category: "Music", lat: 37.7694, lng: -122.4862, distance: 5 },
    { id: 2, title: "Monterey Jazz Festival", date: currentDate, location: "Monterey, CA", description: "A world-class jazz festival.", category: "Music", lat: 36.6002, lng: -121.8947, distance: 50 },
    { id: 3, title: "BottleRock Napa Valley", date: "2025-04-07", location: "Napa, CA", description: "A music, wine, and culinary festival.", category: "Music", lat: 38.2975, lng: -122.2869, distance: 25 },
    ...
    { id: 15, title: "Live Jazz Evening", date: currentDate, location: "Santa Rosa, CA", description: "A relaxing jazz night with local artists.", category: "Music", lat: 38.4404, lng: -122.7141, distance: 5 },
    ...
    { id: 17, title: "Wine & Cheese Tasting", date: "2025-04-07", location: "Sonoma, CA", description: "Explore local wineries with a curated tasting experience.", category: "Food & Drink", lat: 38.2919, lng: -122.4580, distance: 10 },
  
    //Added Health Event for This Weekend
    { id: 18, title: "Yoga in the Park", date: currentDate, location: "Golden Gate Park, CA", description: "An outdoor yoga session for all skill levels.", category: "Health & Fitness", lat: 37.7694, lng: -122.4862, distance: 5 },
    ...
    { id: 8, title: "California State Fair", date: currentDate, location: "Sacramento, CA", description: "A family-friendly fair featuring carnival rides, food, and concerts.", category: "Health & Fitness", lat: 38.5809, lng: -121.4997, distance: 100 },
